...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def process_shift(self, events, shift_name):
        ...
        mbb = ak.mask(mbb, ak.pad_none((j_candidates[jj_i.j1].matched_gen + j_candidates[jj_i.j2].matched_gen).mass, 3, axis=1)>0)
        ...
        chi1, mean1, std1 = chi_square(mbb,116.02, 45.04) # H -> bb            
        chi2, mean2, std2 = chi_square(mlvqq, 173.59, 48.67) # transverse mass
        chi3, mean3, std3 = chi_square(qq.mass,41.77, 14.92) #hadronic W    
